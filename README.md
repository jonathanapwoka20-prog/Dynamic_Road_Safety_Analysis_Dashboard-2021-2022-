...
## The Process (Action Taken)

### A. Data Engineering & Integrity
...
### B. Strategic Data Modeling (Grouping)
...
### C. Advanced Dashboard Architecture
...
* **Year-over-Year Trends:** Identified specific months where casualties peaked in 2022 compared to 2021.
* **Casualty Hotspots:** Established a clear relationship between Road Type and Casualty Volume.
* **Visibility Analysis:** Determined the correlation between Day/Night conditions and casualty rates across locations.
